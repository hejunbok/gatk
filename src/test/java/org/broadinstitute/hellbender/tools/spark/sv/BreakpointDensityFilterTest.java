...
public class BreakpointDensityFilterTest extends BaseTest {
    ...
    private static ReadMetadata initMetadata() {
        ...
        return new ReadMetadata(new HashSet<Integer>(), artificialSamHeader,
    ...
    public void testGetBreakpointClusters(final ReadMetadata readMetadata, final List<BreakpointEvidence> evidenceList) {
        ...
        BreakpointDensityFilter breakpointDensityFilter =
                new BreakpointDensityFilter(0, evidenceList.iterator(), null, 3, 3);
    ...
    public void testGetBreakpointClustersWithCoherentEvidence(final ReadMetadata readMetadata, final List<BreakpointEvidence> evidenceList) {
        ...
        BreakpointDensityFilter breakpointDensityFilter =
                new BreakpointDensityFilter(0, evidenceList.iterator(), null, 5, 3);
    ...
    public void testCrossPartitionEvidence() {
        ...
        final List<Integer> expectedStartList1 =
                Arrays.asList(10001, 10011, 10021, 10131, 10551, 10561, 10571, 12001, 12011, 12021, 19501, 19511, 19521, 19751, 19761, 19771, 19901);
        ...
        final List<Integer> expectedStartList1Clustered =
                Arrays.asList(10001, 10011, 10021, 10131, 10551, 10561, 10571, 12001, 19501, 19511, 19521, 19751, 19761, 19771, 19901);
        ...
        BreakpointDensityFilter breakpointDensityFilter =
                new BreakpointDensityFilter(-1, allPartitions.iterator(), null, 3, 3);
        ...
        final List<Integer> expectedAllPartitions =
                Arrays.asList(1, 551, 2001, 9501, 9511, 9521, 9751, 9761, 9771,
                        10001, 10011, 10021, 10551, 10561, 10571, 12001, 19501, 19511, 19521, 19751, 19761, 19771,
    ...
    private List<BreakpointEvidence> clusterList( final int partitionIdx, final List<BreakpointEvidence> inputList ) {
        ...
        final PartitionEdges partitionEdges = partitionIdx < 0 ? null :
        ...
        final BreakpointEvidence sentinel = new BreakpointEvidence(new SVInterval(readMetadata.getNPartitions(),1,1),0);
